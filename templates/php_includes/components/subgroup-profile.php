<main class="profile profile--group clearfix">
  ...
  <header>
    ...
    <a href="#" class="profile__pic__link"><!-- link to full pic -->
      <img src="tmp_resources/groupPicture06.jpg" class="profile__pic" alt="Green energy in transport logo">
    </a>
    
    <h2 class="profile__title"><a href="base-subgroup-profile.php"><?php echo $title; ?></a></h2>
    <h4>(Subgroup of <a href="base-group-profile.php">Green Energy in Transport</a>)</h4>
    ...
    <ul class="profile__meta">
      <li><i class="far fa-eye-slash"></i> secret group</li>
    </ul>
