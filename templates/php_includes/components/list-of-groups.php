<main class="profile profile--group clearfix">
  ...
  <header>
    ...
    <ul class="profile__networks active">
      <li class="profile__networks__item profile__members"><a href="#" >47 members</a></li>
      <li class="profile__networks__item profile__followers"><a href="#">324 followers</a></li>
      <li class="profile__networks__item profile__subgroups"><a href="#" class="active">4 subgroups</a></li>
    </ul>
