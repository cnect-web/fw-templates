...
<?php includeWithParams("components/header-search-only.php", array(
...
<?php includeWithParams("components/group-profile.php", array(
  'title'=> 'Green Energy in transport community 2',
